...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    List<com.samdevit.efittingku.api.Post> postList;
    Context context;

    public PostAdapter(Context context , List<com.samdevit.efittingku.api.Post> posts){
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        com.samdevit.efittingku.api.Post post = postList.get(position);
