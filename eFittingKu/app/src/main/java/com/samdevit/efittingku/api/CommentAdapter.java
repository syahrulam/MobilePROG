...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentHolder> {
    ...
    Context context;
    List<com.samdevit.efittingku.api.Comment> commentList;

    public CommentAdapter(Context context , List<com.samdevit.efittingku.api.Comment> commentList){
    ...
    public void onBindViewHolder(@NonNull CommentHolder holder, int position) {
        ...
        com.samdevit.efittingku.api.Comment comment = commentList.get(position);
